...
const Home = (props) => {
    ...
    const ListarDespesas = () => {
        ...
        //const soma = dados.reduce(function(valorPrevio, valorAtual){return valorPrevio + valorAtual.valor;}, 0); // outra forma de fazer o calculo abaixo
                ...
                <View>
...

                    {
                        despesas.map((despesa) => {
                            return <Despesa key={despesa.id}
                                id={despesa.id} icon={despesa.icon}  categoria={despesa.categoria} descricao={despesa.descricao} valor={despesa.valor} onClick={OpenDespesa}/>
                        })
                    }
